...
namespace Hudi {
	...
	Ref<Scene> MenuBar::OnImGuiRender(Ref<Scene> scene)
	{
        ...
        if (ImGui::BeginMenuBar())
        {
            if (ImGui::BeginMenu("File"))
            {
                ...
                if (ImGui::MenuItem("Open...", "Ctrl+O"))
                {
                    Ref<Scene> open = OpenScene();
                    o_Scene = open ? open : o_Scene;
                }
    ...
    Ref<Scene> MenuBar::NewScene()
    {
        return NewRef<Scene>(0);
    }

    Ref<Scene> MenuBar::OpenScene()
    {
    ...
    void MenuBar::SaveSceneAs(Ref<Scene> scene)
    {
